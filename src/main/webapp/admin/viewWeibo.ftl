			...
			<div class="list-group">
				...
				<div class="row" style = "margin-bottom:20px">
				  ...
				  <div class="col-lg-9 col-md-9 col-sm-8 col-xs-8">
					  <div class="up-content row" style="height: auto">
							<div class="col-lg-9 col-md-9 col-sm-8 col-xs-8">
				  		<p class="up-sign-nickname" style="padding-left: 0; padding-top: 10px;">
							${weibo.getUser().getUsername()} : ${weibo.getContent()}
				  		</p>
				  		<p class="up-time" style="padding-left: 0">${weibo.getTime()}</p>
						</div>
